...
This format has 1,719,926,784 possible combinations (about 30.7 bits of entropy). It is still intended for readability rather than high-value account security. Use a password manager-generated password for email, banking, administrator and primary accounts.
